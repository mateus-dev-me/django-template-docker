...
.PHONY: migrations
migrations:
	@$(ENV_PREFIX)python app/manage.py makemigrations
	@$(ENV_PREFIX)python app/manage.py migrate
...
.PHONY: shell
shell:
	@$(ENV_PREFIX)python app/manage.py shell_plus


.PHONY: reset_db
reset_db:
	@$(ENV_PREFIX)python app/manage.py reset_db


.PHONY: dbshell
dbshell:
	@$(ENV_PREFIX)python app/manage.py dbshell
